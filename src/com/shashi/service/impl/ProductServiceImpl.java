...
public class ProductServiceImpl implements ProductService {
	...
	public String addProduct(ProductBean product) {
	    ...
	    try {
	        ps = con.prepareStatement("insert into product values(?,?,?,?,?,?,?,?);");  // CHANGED: Added 8th parameter
	        ...
	        ps.setInt(8, product.getDiscount());  // NEW LINE
	...
	public String updateProduct(ProductBean prevProduct, ProductBean updatedProduct) {
	    ...
	    try {
	        ps = con.prepareStatement(
	            "update product set pname=?,ptype=?,pinfo=?,pprice=?,pquantity=?,image=?,discount=? where pid=?");  // CHANGED: Added discount
	        ...
	        ps.setInt(7, updatedProduct.getDiscount());  // NEW LINE
	        ps.setString(8, prevProduct.getProdId());    // CHANGED: Was 7, now 8
	...
	public List<ProductBean> getAllProducts() {
	    ...
	    try {
	        ...
	        while (rs.next()) {
	            ...
	            product.setDiscount(rs.getInt(8));  // NEW: Read discount from database
	...
	public List<ProductBean> getAllProductsByType(String type) {
	    ...
	    try {
	        ...
	        while (rs.next()) {
	            ...
	            product.setProdQuantity(rs.getInt(6));
	            product.setProdImage(rs.getAsciiStream(7));
	            product.setDiscount(rs.getInt(8));  // NEW LINE
	...
	public String updateProductWithoutImage(String prevProductId, ProductBean updatedProduct) {
	    ...
	    try {
	        ps = con.prepareStatement("update product set pname=?,ptype=?,pinfo=?,pprice=?,pquantity=?,discount=? where pid=?");  // CHANGED: Added discount
	        ...
	        ps.setDouble(4, updatedProduct.getProdPrice());
	        ps.setInt(5, updatedProduct.getProdQuantity());
	        ps.setInt(6, updatedProduct.getDiscount());  // NEW LINE
	        ps.setString(7, prevProductId);              // CHANGED: Was 6, now 7
